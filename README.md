...
## Swapping
![Swapping](/photos/swapping.png =500px)
...
![Two ways](/photos/twoways.png =500px)
...
![Bitmaps](/photos/bitmap.png =500px)
...
![Linkedlist](/photos/linkedlist.png =500px)
...
![Virtual Memory](/photos/virtualmemory.jpg =500px)
...
### Page Table
![Virtual Address](/photos/virtualaddress.png =500px)
...
#### Page table entry
![Page Table Entry](/photos/pagetableentry.png =500px)
...
![Page Table Hierarchy](/photos/hierarchy.png =500px)
...
![Inverted Table](/photos/invertedtable.png =500px)
...
![Clock Page Replacement Algorithm](/photos/clock.png =500px)
...
![LRU using hardware](/photos/lruhardware.png =500px)
...
![LRU using software](/photos/lrusoftware.png =500px)
...
![WSClock algorithm](/photos/wsclock.png =500px)
